  ...
  def load_next_batch(self):
    ...
    with maybe_record_goodput(self.goodput_recorder, GoodputEvent.DATA_LOADING):
      try:
        ...
        raise exceptions.StopTraining(f"You may have run out of training data. Error message: {e}")
      except Exception as e:  # pylint: disable=broad-except
        raise exceptions.StopTraining(f"`load_next_batch()` failed. Error message: {e}")
